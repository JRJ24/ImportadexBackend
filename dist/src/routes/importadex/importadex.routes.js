...
const importadex_client_portal_controller_1 = require("../../controllers/importadex/importadex-client-portal.controller");
...
const loginRateLimit_1 = require("../../middlewares/loginRateLimit");
const processFiles_1 = require("../../middlewares/processFiles");
const router = (0, express_1.Router)();
router.use(importadexAdmin_1.attachImportadexUser);
router.post("/client-portal/login", loginRateLimit_1.loginRateLimit, importadex_client_portal_controller_1.importadexClientPortalController.requestLogin);
router.post("/client-portal/verify-otp", loginRateLimit_1.loginRateLimit, importadex_client_portal_controller_1.importadexClientPortalController.verifyOtp);
router.get("/client-portal/me", importadex_client_portal_controller_1.importadexClientPortalController.me);
router.get("/client-portal/operations", importadex_client_portal_controller_1.importadexClientPortalController.listOperations);
router.get("/client-portal/operations/:id", importadex_client_portal_controller_1.importadexClientPortalController.getOperation);
router.post("/client-portal/operations/:id/attachments", processFiles_1.processFile, importadex_client_portal_controller_1.importadexClientPortalController.uploadAttachments);
