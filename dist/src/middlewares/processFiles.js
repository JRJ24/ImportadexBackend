...
const getBucketName = () => process.env.SPACES_NAME || process.env.SPACES_BUCKET || process.env.ACCESS_KEY_NAME;
const buildPublicUrl = (bucketName, key) => {
    ...
    upload(req, res, async (err) => {
        ...
        try {
            ...
            const uploadedFiles = await Promise.all(files.map(async (file) => {
                ...
                let fileName = `${(0, crypto_1.randomUUID)()}-${originalName}`;
...
exports.processAndUpload = exports.processFile;
